<template>
  <header
    class="flex items-center justify-center hover:bg-white transition duration-500 group"
  >
    <div
      ...
      <div class="flex flex-row items-center">
        ...
        >
          ...
          >
            Dịch vụ
            <!-- hover -->
            <div class="group-hover/service:flex hidden absolute top-[10px] w-full h-[100px] z-[100]">
              <div
